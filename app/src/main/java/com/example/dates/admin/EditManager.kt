...
import com.example.dates.databinding.ActivityEditManagerBinding
...
class EditManager : AppCompatActivity() {
    private lateinit var binding: ActivityEditManagerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditManagerBinding.inflate(layoutInflater)
        ...
        binding.btnEdit.setOnClickListener {
            ...
            if (isConnected.isInternetAvailable()) {
                viewModel.editManager(id, name, email, pass)
